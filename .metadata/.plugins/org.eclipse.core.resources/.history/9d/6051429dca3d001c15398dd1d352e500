...
public abstract class Move {
	...
	/*
	 * Inner class used for when the players castle.
	 * has subclasses depending on which way it goes.
	 */
	static abstract class CastleMove extends Move {
	 ...
	 protected final int castleRookDestination;
		...
		/*
		 * Execute method overriden for the board to be updated
	...
	// Inner subclass for the king side castle.
 ...
 //inner subclass for queen side castle
 ...
 // Error checking to see if the move is null.
 ...
 /*
  * Inner class with helpful methods.
  * @method createMove creates every legal move in both players legal moves.
  */
 public static class MoveFactory {
	 ...
	 private MoveFactory() {
	 	...
	 	public static Move createMove(final Board board,
	 								...
	 								final int destinationCoordinate) {
	 		/*
	 		 * if the moves coordinate is equal to the current coordinate and the moves destination coordinate then it returns every move.
	 		 */
